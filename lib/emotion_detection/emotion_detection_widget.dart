  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ImageRecognitionRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ImageRecognitionRecord>
            emotionDetectionImageRecognitionRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final emotionDetectionImageRecognitionRecord =
            emotionDetectionImageRecognitionRecordList.isNotEmpty
                ? emotionDetectionImageRecognitionRecordList.first
                : null;
                          ...
                          Expanded(
                            child: SizedBox(
                              ...
                              child: custom_widgets.ImageRecognitionWidget(
                                width: 300.0,
                                height: 200.0,
                                imageUrl: emotionDetectionImageRecognitionRecord
                                    ?.imageUrl,
                              ),
                            ),
                          ),
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            ...
                            if (_model.isDataUploading) {
                              ...
                              await emotionDetectionImageRecognitionRecord!
                                  .reference
                                  .update(createImageRecognitionRecordData(
                                imageUrl: _model.uploadedFileUrl,
                              ));
                            }
                          },
